...
var _imageList = [
  ...
  {
    tileType: TILE_MASTER_KEY,
    theFile: "images/pickup_masterKey.png",
    tileValue: 7,
  },
  ...
  {
    tileType: TILE_FREEZE_SCROLL,
    theFile: "images/pickup_spell_scroll.png",
    tileValue: 12,
  },

  {
    tileType: TILE_CRYPT_WALL1,
    theFile: "images/crypt_wall1.png",
    tileValue: 20,
  },
  {
    tileType: TILE_CRYPT_WALL2,
    theFile: "images/crypt_wall2.png",
    tileValue: 21,
  },
  {
    tileType: TILE_CRYPT_WALL3,
    theFile: "images/crypt_wall3.png",
    tileValue: 22,
  },
  {
    tileType: TILE_CRYPT_DAMAGE_FLOOR,
    theFile: "images/crypt_damageFloor.png",
    tileValue: 23,
  },

  //Row 1: GardenSpriteSheet
  {
    tileType: TILE_GARDEN_WALL1,
    tileValue: 30,
    theFile: "images/MapEditorSpecific/gardenWall1.png",
  },
  {
    tileType: TILE_GARDEN_WALL2,
    tileValue: 31,
    theFile: "images/MapEditorSpecific/gardenWall2.png",
  },
  {
    tileType: TILE_GARDEN_WALL3,
    tileValue: 32,
    theFile: "images/MapEditorSpecific/gardenWall3.png",
  },
  {
    tileType: TILE_GRASS,
    tileValue: 33,
    theFile: "images/MapEditorSpecific/grass.png",
  },
  {
    tileType: TILE_BUSH_TOP,
    tileValue: 34,
    theFile: "images/MapEditorSpecific/bush-top.png",
  },
  {
    tileType: TILE_BUSH_BOTTOM,
    tileValue: 35,
    theFile: "images/MapEditorSpecific/bush-bottom.png",
  },
  //OPEN
  //OPEN
  {
    tileType: TILE_GARDEN_WATER1,
    tileValue: 38,
    theFile: "images/MapEditorSpecific/water.png",
  },

  //Row 2:
  {
    tileType: TILE_TREE_TOPLEFT,
    tileValue: 40,
    theFile: "images/MapEditorSpecific/tree-topLeft.png",
  },
  {
    tileType: TILE_TREE_TOPRIGHT,
    tileValue: 41,
    theFile: "images/MapEditorSpecific/tree-topRight.png",
  },
  {
    tileType: TILE_TREE_MIDLEFT,
    tileValue: 42,
    theFile: "images/MapEditorSpecific/tree-midLeft.png",
  },
  {
    tileType: TILE_TREE_MIDRIGHT,
    tileValue: 43,
    theFile: "images/MapEditorSpecific/tree-midRight.png",
  },
  {
    tileType: TILE_TREE_BOTLEFT,
    tileValue: 44,
    theFile: "images/MapEditorSpecific/tree-botLeft.png",
  },
  {
    tileType: TILE_TREE_BOTRIGHT,
    tileValue: 45,
    theFile: "images/MapEditorSpecific/tree-botRight.png",
  },

  //Enemies
  { tileType: TILE_GHOST, tileValue: 60, theFile: "images/ghostSprite_1.png" },
  {
    tileType: TILE_ZOMBIE,
    tileValue: 61,
    theFile: "images/zombieSprite_1.png",
  },
  {
    tileType: TILE_WALL_HUGGER,
    tileValue: 62,
    theFile: "images/wall_hugger_1.png",
  },
  {
    tileType: TILE_TURRET,
    tileValue: 63,
    theFile: "images/turret_sprite_1.png",
  },
  //OPEN
  //OPEN
  //OPEN
...
function setupTileButtons() {
  ...
  load_level_lbl.innerHTML =
    "Load a level (0 is shop, otherwise, n is nth level)";
  ...
  load_level_btn.addEventListener("click", () => {
    ...
    if (levelToLoad == "") {
      console.log(
        "You need to click on the arrows on the input to insert an integer."
      );
      return;
    }
...
function _generateReadableMapData() {
  ...
  const out =
    "Copy and paste me into js/Levels.js:\n\nlevel[X] =\n    [\n" +
    listInnerString +
    "\n    ];";
  console.log(out);
}
...
function quitLevelInEditor() {
  if (!_inEditorPlayMode) {
    console.log(
      "Attempted to stop playing level in editor even though not playing level in editor."
    );
    return;
  }
